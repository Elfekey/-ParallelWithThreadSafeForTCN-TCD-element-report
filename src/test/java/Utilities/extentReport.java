...
private static String reportName;
	...
	public static void  setUpExtent() {//ExtentReports
		...
		startTimeOfTestCase=GetCurrenDateAndTime();
//		System.out.println(startTimeOfTestCase);
	...
	public synchronized void InsertAllImagesToTheReport(String tCName, String tCDescription, String status) {
		try {
			...
			File imagesSrcFilePath = new File(fullDirectory +tCName+"_"+tCDescription+"_"+status+"_"+endTimeOfTestCase);

			//####check first if the screenshots folder exists####
			if (imagesSrcFilePath.exists() && imagesSrcFilePath.isDirectory()) {

				String imagesPath = fullDirectory+tCName+"_"+tCDescription+"_"+status+"_"+endTimeOfTestCase+"/";
